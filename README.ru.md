...
[![Docs](https://img.shields.io/badge/docs-mkdocs--material-blue.svg)](https://drobyshevdev.github.io/mlango/)
...
перед промоутом, `manage.py promote --check` ставит то же правило на сам промоут,
а `--format markdown` публикует сравнение в пул-реквесте, где сидит остальная
команда. Та же команда сравнивает **два прогона набора оценок агента**
